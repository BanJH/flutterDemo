...
class NoteDbHelper {
        ...
        onCreate: (Database db, int version) async {
          await db.execute(
              "create table notes (_id INTEGER primary key autoincrement,"
                  "title TEXT not null,content TEXT not null,star INTEGER  not null,time "
                  "INTEGER not null,weather INTEGER not null)");
  ...
  Future<int> update(Note note) async {
    return await db.update('notes', note.toMap(),where: '_id = ?',whereArgs: [note.id]);
  }
