...
import 'package:flutter_notes/ui/read.dart';
...
class _SearchPageState extends State<SearchPage> {
  ...
  void _search() async {
    ...
    await Future.delayed(Duration(seconds: 0),() {
      widget.noteDbHelper!.getNoteByContent(keyString).then((List<Note>? notes) {
        if(notes != null) {
          setState(() {
            _size = notes.length;
            _noteList = notes;
             ...
             children: <Widget>[
               Container(
                 ...
                 child: Row(
                   children: <Widget>[
                     Text(
                       '${DateTime.fromMillisecondsSinceEpoch(_noteList
                           .elementAt(index).time as int).day}',
                       style: TextStyle(
                     ...
                     Column(
                       ...
                       children: <Widget>[
                         Text(
                           '星期${TimeUtils.getWeekday(DateTime.fromMillisecondsSinceEpoch(_noteList
                               .elementAt(index).time as int).weekday)}',
                           style: TextStyle(
              ...
              children: <Widget>[
                Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      Text(
                        '${DateTime.fromMillisecondsSinceEpoch(_noteList.elementAt(index).time as int).day}',
                        style: TextStyle(
